...
export default function Page() {
  ...
  return (
    <>
      ...
      >
        {/* Background Elements (dibikin non-interaktif biar gak nutup klik) */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Full Stack Developer &amp; Solution Architect (7+ yrs) — web,
                mobile, dan cloud. Fokus kecepatan rilis, keamanan, dan impact
                bisnis.
              </p>
            ...
            {[
              {
                ...
                desc: "Modern, responsive websites and web applications using React, Next.js, Vue.js, and Node.js with focus on performance and SEO.",
                items: [
              ...
              },
              {
                ...
                desc: "Scalable cloud infrastructure on AWS, Google Cloud, and Azure. DevOps, CI/CD, and containerization with Docker & Kubernetes.",
                items: [
                  "• AWS/GCP/Azure Setup",
                  "• Docker & Kubernetes",
                  "• CI/CD Pipelines",
              ...
              },
              {
                icon: "fa-paint-brush",
                title: "UI/UX Design",
                desc: "User-centered design approach with wireframing, prototyping, and visual design using Figma, Adobe XD, and design systems.",
                items: [
              ...
              },
              {
                ...
                desc: "Database design, data analytics, business intelligence dashboards, and machine learning integration for data-driven insights.",
                items: [
              ...
              },
              {
                ...
                desc: "Strategic technology consulting, code reviews, architecture planning, and team mentoring for optimal development practices.",
                items: [
                  "• Technology Strategy",
                  "• Code Reviews",
                  "• Team Mentoring",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-in-left" data-reveal>
              ...
              <p className="text-lg text-gray-600 mb-8">
                I combine technical expertise with business acumen to deliver
      ...
      <section className="py-20 bg-gray-50" data-reveal>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up" data-reveal>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A showcase of recent successful projects and solutions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                {/* Pakai ratio utility bawaan Tailwind */}
                <div
                  className={`aspect-[16/9] bg-gradient-to-r ${p.grad} p-8 flex items-center justify-center`}
                >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14" data-reveal>
            ...
            <h2 className="mt-4 text-3xl lg:text-4xl font-bold text-gray-900">
              Quick Tutorials: Laravel, React, Next.js
            </h2>
            <p className="mt-3 text-lg text-gray-600">
              Starter ringkas biar kamu langsung ngoding &amp; paham alur
              dasarnya.
            </p>
          </div>
